            ...
            >
              ...
              >
                <motion.a
                  ...
                  className={`inline-flex items-center px-8 py-4 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                ...
                <motion.a
                  href="#skills"
                  className={`inline-flex items-center px-8 py-4 border-2 font-semibold rounded-lg transition-all duration-300 ${
                    isDarkMode
            ...
            {certifications.map((cert, index) => (
              <motion.div
                ...
                className={`p-6 rounded-lg border-l-4 ${
                  isDarkMode ? 'border-white bg-[#222222]' : 'border-black bg-white'
                } shadow-lg`}
              >
