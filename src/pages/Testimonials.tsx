...
import { Star, User, Globe, MessageSquare, HelpCircle } from 'lucide-react';
...
export const Testimonials: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen pt-16 ${isDarkMode ? 'bg-[#222222]' : 'bg-gray-50'}`}>
      ...
      {/* Write a Review Form */}
      <section className={`py-20 ${isDarkMode ? 'bg-[#222222]' : 'bg-gray-50'}`}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border transition-colors ${
                    errors.name
                      ...
                      : isDarkMode
                        ? 'border-[#1d1d1d] bg-[#1d1d1d] text-white focus:border-white'
                        : 'border-gray-300 bg-white text-gray-900 focus:border-black'
                  } focus:outline-none focus:ring-2 ${
                    isDarkMode ? 'focus:ring-white/20' : 'focus:ring-black/20'
                  }`}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full px-8 py-4 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center ${
                  isDarkMode ? 'bg-white text-black' : 'bg-black text-white'
                }`}
              >
